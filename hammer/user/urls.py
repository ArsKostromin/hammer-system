...
from .views import UsertViewSet, RequestPhoneView,RequestLoginCodeView, VerifySMSCodeView, UserProfileView, VerifyLoginCodeView
...
urlpatterns = [
    ...
    path('profiles/',UsertViewSet.as_view(), name='profiles'),
    ]